...
const PokemonCard = (props) => {
  ...
  const evolvePokeMon = (e) => {
    ...
    let { name, type, evolved, weigth, color, image, id } = props.pokeMon[props.id]
    ...
    return (
      ...
      <EvolveButton id={'pm' + id} onClick={(e) => evolvePokeMon(e)} evolved={evolved}>{!evolved ? 'Evoluir!' : 'Evoluido!'} </EvolveButton>
    </Card>
